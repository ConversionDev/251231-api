package store.kanggyeonggu.gateway.oauthservice.google;
...
public class GoogleController {
    ...
    public GoogleController(GoogleOAuthService googleOAuthService, JwtService jwtService, OAuthUserService userService) {
    ...
    private ResponseEntity<Void> processCallback(String code) {
        try {
            ...
            store.kanggyeonggu.gateway.common.entity.User user = userService.upsertUser(
                    "google",
                    googleId,
                    nickname,
                    profileImageUrl
